...
//
// An empty set means the reader cleared every episode, and that is applied. A row that states
// no set at all leaves the set on this device alone, and this browser sends it one. The two are
// told apart by null and not by emptiness: an empty object is true in a condition, so testing
// the object itself gets this backwards.
